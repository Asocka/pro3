...
import youtube_dl
#=============
#cl = LineClient(authToken='EwKBNHhnhj3CzVNz7A48.N9J7K820l+ZNOptEskZvga.+SUbhoA6r79oe6HzbRYbzIXqbYCQGa4KJSXdIeQ5qVM=')
cl = LineClient()
...
#ki = LineClient(authToken='EvGGf64AlncX3H3w34Bd.Px9BHWgxTriqj72/6/7Klq.DiRs3VbJXLnI2u3ZO+CeGCDxUHbq4ymufYIxTtqB4KE=')
ki = LineClient()
...
#kk = LineClient(authToken='Ev65g5XFYyoDMd4zLtV1.uj7buM8LZ21E8A26r1AIuq.fS6iUdwfrlwrUDbJliGK5lJpSNSHffedv+cCjFZvPTU=')
kk = LineClient()
...
#kc = LineClient(authToken='EvRgiw9fVZGwnV6IZU39.1wOIGRe59KSKeP9a61Jtkq.0ZVlsl/QhqNo51Wy6TROE08c3h5Eg6EP3pN/BcLxJmI=')
kc = LineClient()
...
#km = LineClient(authToken='EvrvqUfOXnXgDq1cqaA0.r4McA4mrqdD368n6EdNqSa.fZV6NXKwWdURAzsNZ/y6dJ+v94pnE0xeH7GyGuEgAEc=')
km = LineClient()
...
#kb = LineClient(authToken='EvzuphihpEIzh6haKyQd.9G75DEadFbnu33ihis0EVq.7VDJkvr/uXJjRnuiFQR8iuiJY7DAKLV0nzF5qqpn7xQ=')
kb = LineClient()
...
#sw = LineClient(authToken='EwzDiqcoD5ukD8ndsOp7.44G9jPStVQDUTxG1jBdNPW.o4qpMHCLvJuz74jvJzD9f/qws/rMyE56yP0uQ92OlRs=')
sw = LineClient()
...
creator = ["u56b881ef5d1f12b9f4a5ef92507659d5"]
owner = ["u56b881ef5d1f12b9f4a5ef92507659d5"]
admin = ["u56b881ef5d1f12b9f4a5ef92507659d5"]
staff = ["u56b881ef5d1f12b9f4a5ef92507659d5"]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
