...
kr = LineClient(authToken='TOKEN')
kr.log("Auth Token : " + str(kr.authToken))
channel3 = LineChannel(kr)
kr.log("Channel Access Token : " + str(channel3.channelAccessToken))

kq = LineClient(authToken='TOKEN')
kq.log("Auth Token : " + str(kq.authToken))
channel3 = LineChannel(kq)
kq.log("Channel Access Token : " + str(channel3.channelAccessToken))

cxb = LineClient(authToken='TOKEN')
cxb.log("Auth Token : " + str(cxb.authToken))
channel11 = LineChannel(cxb)
cxb.log("Channel Access Token : " + str(channel11.channelAccessToken))
...
Emid = kq.getProfile().mid
Zmid = cxb.getProfile().mid
KAC = [cl,ki,kk,kc,kr,kq]
ABC = [ki,kk,kc,kr,kq]
...
responsename5 = kq.getProfile().displayName
...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"NAH..JONES NGINTIP.!!",
    "Respontag":"ɴɢᴀᴘᴀɪɴ ɴɢᴇᴛᴀɢ ғᴀɴs ʏᴀᴀ..",
    "welcome":"Welcom to my fams,,Semoga croot ",
    "comment2":"AUTO LIKE BY: PRILLY",    
    #"comment":"ᴀᴜᴛᴏ ʟɪᴋᴇ ʙʏ: PRILLY",
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    if kr.getGroup(op.param1).preventedJoinByTicket == False:
                                        if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                            kr.reissueGroupTicket(op.param1)
                                            X = kr.getGroup(op.param1)
                                            X.preventedJoinByTicket = True
                                            kr.updateGroup(X)
                                            kr.sendMessage(op.param1, None, contentMetadata={'mid': op.param2}, contentType=13)
                                except:
                                    try:
                                        if ki.getGroup(op.param1).preventedJoinByTicket == False:
                                            if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                                kq.reissueGroupTicket(op.param1)
                                                X = kq.getGroup(op.param1)
                                                X.preventedJoinByTicket = True
                                                kq.updateGroup(X)
                                                kq.sendMessage(op.param1, None, contentMetadata={'mid': op.param2}, contentType=13)
                                    except:
                                        try:
                                            if cl.getGroup(op.param1).preventedJoinByTicket == False:
                                                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
            ...
            if Amid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        ki.sendMessage(op.param1,"Bye\n Group " +str(ginfo.name))
                        ki.leaveGroup(op.param1)
                    else:
                        ki.acceptGroupInvitation(op.param1)
                        ginfo = ki.getGroup(op.param1)
                        ki.sendMessage(op.param1,"Hello " + str(ginfo.name))
            if Bmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        kk.acceptGroupInvitation(op.param1)
                        ginfo = kk.getGroup(op.param1)
                        kk.sendMessage(op.param1,"Bye\n Group " +str(ginfo.name))
                        kk.leaveGroup(op.param1)
                    else:
                        kk.acceptGroupInvitation(op.param1)
                        ginfo = kk.getGroup(op.param1)
                        kk.sendMessage(op.param1,"Hello " + str(ginfo.name))
            if Cmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        kc.acceptGroupInvitation(op.param1)
                        ginfo = kc.getGroup(op.param1)
                        kc.sendMessage(op.param1,"Bye\n Group " +str(ginfo.name))
                        kc.leaveGroup(op.param1)
                    else:
                        kc.acceptGroupInvitation(op.param1)
                        ginfo = kc.getGroup(op.param1)
                        kc.sendMessage(op.param1,"Hello " + str(ginfo.name))
            if Dmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        kr.acceptGroupInvitation(op.param1)
                        ginfo = kr.getGroup(op.param1)
                        kr.sendMessage(op.param1,"Bye\n Group " +str(ginfo.name))
                        kr.leaveGroup(op.param1)
                    else:
                        kr.acceptGroupInvitation(op.param1)
                        ginfo = kr.getGroup(op.param1)
                        kr.sendMessage(op.param1,"Hello " + str(ginfo.name))
            if Emid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        kq.acceptGroupInvitation(op.param1)
                        ginfo = kq.getGroup(op.param1)
                        kq.sendMessage(op.param1,"Bye\n Group " +str(ginfo.name))
                        kq.leaveGroup(op.param1)
                    else:
                        kq.acceptGroupInvitation(op.param1)
                        ginfo = kq.getGroup(op.param1)
                        kq.sendMessage(op.param1,"Hello " + str(ginfo.name))
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        gMembMids = [contact.mid for contact in group.invitee]
                                        for _mid in gMembMids:
                                            kr.cancelGroupInvitation(op.param1,[_mid])
                                    except:
                                        try:
                                            group = kq.getGroup(op.param1)
                                            gMembMids = [contact.mid for contact in group.invitee]
                                            for _mid in gMembMids:
                                                kq.cancelGroupInvitation(op.param1,[_mid])
                                        except:
                                            pass
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    try:
                                        kq.kickoutFromGroup(op.param1,[op.param2])
                                        kq.inviteIntoGroup(op.param1,[op.param3])
                                        cl.acceptGroupInvitation(op.param1)                         
                                    except:
                                        try:
               ...
               if msg.contentType == 13:
                 ...
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["dellbots"] = True
                        ki.sendMessage(msg.to,"Contact not listbot quita")
#ADD STAFF
                 if msg._from in admin:
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                        if Amid in Setmain["RAfoto"]:
                            ...
                            kq.sendMessage(msg.to,"Succes")    
                        elif Zmid in Setmain["RAfoto"]:
                            path = cxb.downloadObjectMsg(msg_id)
                            del Setmain["RAfoto"][Zmid]
                            cxb.updateProfilePicture(path)
                            cxb.sendMessage(msg.to,"Succes")
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                   if settings["changePicture"] == True:
                     ...
                     path1 = kr.downloadObjectMsg(msg_id)
                     path2 = kq.downloadObjectMsg(msg_id)
                #     path3 = kc.downloadObjectMsg(msg_id)                      
                     ...
                     kr.updateProfilePicture(path2)
                     kr.sendMessage(msg.to, "Succes change pic")
                     kq.updateProfilePicture(path3)
                     kq.sendMessage(msg.to, "Succes change pic")
                        ...
                        if cmd == "bot on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                else: md+="􀔃􀆓lock and key􏿿  Cᴏɴᴛᴀᴄᴛ ➳「⚪」\n"
                                if wait["talkban"] == True: md+="􁤁􀇜key􏿿  Tᴀʟᴋʙᴀɴ ➳「⚫」\n"
                                else: md+="􀔃􀆓lock and key􏿿  Tᴀʟᴋʙᴀɴ ➳「⚪」\n"
                                if wait["Mentionkick"] == True: md+="􁤁􀇜key􏿿  Tᴀɢ ᴋɪᴄᴋ ➳「⚫」\n"
                                else: md+="􀔃􀆓lock and key􏿿  Tᴀɢ ᴋɪᴄᴋ ➳「⚪」\n"
                                if wait["detectMention"] == True: md+="􁤁􀇜key􏿿  Rᴇsᴘᴏɴ Tᴀɢ ➳「⚫」"
                                else: md+="􀔃􀆓lock and key􏿿  Rᴇsᴘᴏɴ Tᴀɢ ➳「⚪」\n"
                                if wait["autoJoin"] == True: md+="􁤁􀇜key􏿿  Aᴜᴛᴏ ᴊᴏɪɴ ➳「⚫」\n"
                                else: md+="􀔃􀆓lock and key􏿿  Aᴜᴛᴏ ᴊᴏɪɴ ➳「⚪」\n"
                                if wait["autoAdd"] == True: md+="􁤁􀇜key􏿿  Aᴜᴛᴏ ᴀᴅᴅ ➳「⚫」\n"
                                else: md+="􀔃􀆓lock and key􏿿  Aᴜᴛᴏ ᴀᴅᴅ ➳「⚪」\n"
                                if msg.to in welcome: md+="􁤁􀇜key􏿿  Wᴇʟᴄᴏᴍᴇ ➳「⚫」\n"
                                else: md+="􀔃􀆓lock and key􏿿  Wᴇʟᴄᴏᴍᴇ ➳「⚪」\n"
                                if wait["autoLeave"] == True: md+="􁤁􀇜key􏿿  Aᴜᴛᴏ ʟᴇᴀᴠᴇ ➳「⚫」\n"
                                else: md+="􀔃􀆓lock and key􏿿  Aᴜᴛᴏ ʟᴇᴀᴠᴇ ➳「⚪」\n"
                                if msg.to in protectqr: md+="􁤁􀇜key􏿿  Pʀᴏᴛᴇᴄᴛ Uʀʟ ➳「⚫」\n"
                                else: md+="􀔃􀆓lock and key􏿿  Pʀᴏᴛᴇᴄᴛ Uʀʟ ➳「⚪」\n"
                                if msg.to in protectjoin: md+="􁤁􀇜key􏿿  Pʀᴏᴛᴇᴄᴛ ᴊᴏɪɴ ➳「⚫」\n"
                                else: md+="􀔃􀆓lock and key􏿿  Pʀᴏᴛᴇᴄᴛ ᴊᴏɪɴ ➳「⚪」\n"
                                if msg.to in protectkick: md+="􁤁􀇜key􏿿  Pʀᴏᴛᴇᴄᴛ ᴋɪᴄᴋ ➳「⚫」\n"
                          ...
                          if msg._from in admin:
                            ...
                            for i in group:
                                ...
                                if ginfo == group:
                                    ...
                                    k4.leaveGroup(i)
                                    k5.leaveGroup(i)
                                    ki.sendMessage(msg.to,"Succes leave in group " +str(ginfo.name))
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               kr.sendMessage(msg.to,"╔══[ GROUP LIST ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               kq.sendMessage(msg.to,"╔══[ GROUP LIST ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                kq.sendText(msg.to,"➣Send pict.....")
                                                
                        elif cmd == "kickerup":
                            if msg._from in admin:
                                Setmain["RAfoto"][Zmid] = True
                                cxb.sendText(msg.to,"➣Send pict.....")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                kq.sendMessage(msg.to,"Succes " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            string = msg.text.replace(separate[0] + " ","")
                            if len(string) <= 10000000000:
                                profile = cxb.getProfile()
                                profile.displayName = string
                                cxb.updateProfile(profile)
                                cxb.sendMessage(msg.to,"Succes " + string + "")
                                
#===========BOT UPDATE============#
                        elif cmd == "tag" or text.lower() == 'desah':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
  ...
  #[==Finish===]    
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"  『¤Daftar ListBot¤』\n\n"+ma+"\nTotal : 『%s』 Bot" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                kq.sendMessage(msg.to,responsename5)
                                #k1.sendMessage(msg.to,responsename3)

                                
                        elif cmd == "allbot join":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    anggota = [Bmid,Cmid,Dmid,Emid,Amid]
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                for i in gid:
                                    ...
                                    if h == ng:
                                        ki.sendMessage(i, "Please invite admin or staff quita bot")
                                        ki.leaveGroup(i)
                                        kk.leaveGroup(i)
                                        kc.leaveGroup(i)
                                        kr.leaveGroup(i)
                                        kq.leaveGroup(i)
                                        ki.sendMessage(to,"Leave succes " +h)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:                              
                               start = time.time()
                               time.sleep(0.01)  
                               cl.sendMessage(to, "ᴘʀᴏɢʀᴇs sᴘᴇᴇᴅ...")
                          ...
                          if msg._from in admin:
                            if msg.to in Setmain['RAreadPoint']:
                                ...
                                cl.sendText(msg.to, "Ketik lurking on ")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                             if msg.toType == 2:
                                ...
                                jmlh = int(wait["limit"])
                                cl.sendMessage(msg.to, "Succes {} Spam Call Grup".format(str(wait["limit"])))
                                if jmlh <= 1000:
                                  for x in range(jmlh):
                                     try:
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendText(msg.to,"Notag allready on")

                        elif cmd == "notag off" or text.lower() == 'notag off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["MentionKick"] = False
                                cl.sendText(msg.to,"Notag allready off")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["sticker"] = True
                                cl.sendText(msg.to,"Sticker allready on")

                        elif cmd == "sticker off" or text.lower() == 'sticker off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["sticker"] = False
                                cl.sendText(msg.to,"Sticker alleady off")

                        elif cmd == "jointicket on" or text.lower() == 'jointicket on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoinTicket"] = True
                                cl.sendText(msg.to,"Join ticket allready on")
...
#===========COMMAND BLACKLIST============#
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"•☠『Quita Blacklist User』☠•\n\n"+ma+"\n➳「%s」Blacklist User ☑" %(str(len(wait["blacklist"]))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              cl.sendMessage(msg.to,"Sukses Clear Allblacklist " +mc)
#===========COMMAND SET============#
                            ...
                            if msg._from in admin:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     kr.acceptGroupInvitationByTicket(group2.id,ticket_id)
                                     kr.sendMessage(msg.to, "Masuk : %s" % str(group.name))
                                     group5 = kq.findGroupByTicket(ticket_id)
                                     kq.acceptGroupInvitationByTicket(group3.id,ticket_id)
