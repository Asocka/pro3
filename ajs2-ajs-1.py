...
#kl = LineClient()
kl = LineClient(authToken='MASUKAN TOKENMU DISINI')
kl.log("Auth Token : " + str(kl.authToken))
channel4 = LineChannel(kl)
kl.log("Channel Access Token : " + str(channel4.channelAccessToken))

#km = LineClient()
km = LineClient(authToken='MASUKAN TOKENMU DISINI')
kc.log("Auth Token : " + str(km.authToken))
...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"LAGI NGAPAIN NESS 😊",
    "Respontag":"SEKAARNG TAG BESOK MATI MENDADAK",
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    try:
                                        group = kl.getGroup(op.param1)
                                        gMembMids = [contact.mid for contact in group.invitee]
                                        for _mid in gMembMids:
                                            kl.cancelGroupInvitation(op.param1,[_mid]
                                   except:
                                       try:
