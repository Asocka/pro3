...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"NGAPAIN NESSS 🤔",
    "Respontag":"SEKARANG TAG BESOK MATI MENDADAK",
    "welcome":"Selamat datang & semoga betah",
    "comment":"Like like & like by JEMBUT LEBAT",
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    kl.kickoutFromGroup(op.param1,[op.param2])
                                    kl.findAndAddContactsByMid(op.param1,admin)
                                    ...
                                    try:
                                        ...
                                        try:
                                            kr.kickoutFromGroup(op.param1,[op.param2])
                                            kr.findAndAddContactsByMid(op.param1,admin)
                        ...
                        if cmd == "self on":
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, "Mbutt Fams Grup Info\n\n✵Nama Group : {}".format(G.name)+ "\n✵ID Group : {}".format(G.id)+ "\n✵Pembuat : {}".format(G.creator.displayName)+ "\n✵Waktu Dibuat : {}".format(str(timeCreated))+ "\n✵Jumlah Member : {}".format(str(len(G.members)))+ "\n✵Jumlah Pending : {}".format(gPending)+ "\n✵Group Qr : {}".format(gQr)+ "\n✵Group Ticket : {}".format(gTicket))
...
#===========BOT UPDATE============#
                        elif cmd == "tagall" or text.lower() == 'jembut':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"✵ŠÃÑĢ  bot\n\n"+ma+"\nTotal「%s」 Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"✵ŠÅÑĢ  admin\n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」 ŠÆÑĞ" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                kl.sendMessage(msg.to,responsename4)
                                km.sendMessage(msg.to,responsename5)
                                kr.sendMessage(msg.to,responsename6)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "✵MBŮȚ Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
                        ...
                        elif cmd == "sider on" or cmd == "mbut on":
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                        ...
                        elif cmd == "sider off" or cmd == "mbut off":
                          if wait["selfbot"] == True:
                           if msg._from in admin:
